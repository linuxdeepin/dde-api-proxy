...
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Display.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
"    <property access=\"read\" type=\"b\" name=\"SupportColorTemperature\"/>\n"
"  </interface>\n"
        "")
public:
...
public: // PROPERTIES
    ...
    Q_PROPERTY(bool SupportColorTemperature READ supportColorTemperature)
