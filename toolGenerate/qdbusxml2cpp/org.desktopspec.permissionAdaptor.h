...
#ifndef ORG_DESKTOPSPEC_PERMISSIONADAPTOR_H
#define ORG_DESKTOPSPEC_PERMISSIONADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.desktopspec.permission.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface org.desktopspec.permission
 */
class PermissionAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.desktopspec.permission")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"org.desktopspec.permission\">\n"
...
"  </interface>\n"
        "")
public:
    PermissionAdaptor(QObject *parent);
    virtual ~PermissionAdaptor();
