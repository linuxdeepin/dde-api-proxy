...
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.AirplaneMode1Adaptor.h"
...
bool AirplaneMode1Adaptor::hasAirplaneMode() const
{
    // get the value of property HasAirplaneMode
    return qvariant_cast< bool >(parent()->property("HasAirplaneMode"));
}
...
void AirplaneMode1Adaptor::Enable(bool in0)
{
    // handle method call org.deepin.dde.AirplaneMode1.Enable
    QMetaObject::invokeMethod(parent(), "Enable", Q_ARG(bool, in0));
}

void AirplaneMode1Adaptor::EnableBluetooth(bool in0)
{
    // handle method call org.deepin.dde.AirplaneMode1.EnableBluetooth
    QMetaObject::invokeMethod(parent(), "EnableBluetooth", Q_ARG(bool, in0));
}

void AirplaneMode1Adaptor::EnableWifi(bool in0)
{
    // handle method call org.deepin.dde.AirplaneMode1.EnableWifi
    QMetaObject::invokeMethod(parent(), "EnableWifi", Q_ARG(bool, in0));
}
