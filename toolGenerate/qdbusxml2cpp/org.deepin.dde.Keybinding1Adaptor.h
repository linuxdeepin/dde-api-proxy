...
#ifndef ORG_DEEPIN_DDE_KEYBINDING1ADAPTOR_H
#define ORG_DEEPIN_DDE_KEYBINDING1ADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.Keybinding1.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface org.deepin.dde.Keybinding1
 */
class Keybinding1Adaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
...
"  </interface>\n"
        "")
public:
    Keybinding1Adaptor(QObject *parent);
    virtual ~Keybinding1Adaptor();
