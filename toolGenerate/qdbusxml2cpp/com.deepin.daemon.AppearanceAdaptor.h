 ...
 * Command line was: qdbusxml2cpp ./dde-api-proxy/file/dbus/v0/session/com.deepin.daemon.Appearance.xml -a ./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.AppearanceAdaptor -i ./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Appearance.h
 *
...
#ifndef COM_DEEPIN_DAEMON_APPEARANCEADAPTOR_H
#define COM_DEEPIN_DAEMON_APPEARANCEADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Appearance.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.deepin.daemon.Appearance
 */
class AppearanceAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.deepin.daemon.Appearance")
...
"  </interface>\n"
        "")
public:
    AppearanceAdaptor(QObject *parent);
    virtual ~AppearanceAdaptor();
