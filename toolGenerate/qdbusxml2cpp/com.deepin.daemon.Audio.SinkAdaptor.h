 ...
 * Command line was: qdbusxml2cpp ./dde-api-proxy/file/dbus/v0/session/com.deepin.daemon.Audio.Sink.xml -a ./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Audio.SinkAdaptor -i ./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Audio.Sink.h
 *
...
#ifndef COM_DEEPIN_DAEMON_AUDIO_SINKADAPTOR_H
#define COM_DEEPIN_DAEMON_AUDIO_SINKADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Audio.Sink.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.deepin.daemon.Audio.Sink
 */
class SinkAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.deepin.daemon.Audio.Sink")
