...
#ifndef COM_DEEPIN_DAEMON_AUDIOADAPTOR_H
#define COM_DEEPIN_DAEMON_AUDIOADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Audio.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.deepin.daemon.Audio
 */
class AudioAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.deepin.daemon.Audio")
...
"    <property access=\"read\" type=\"s\" name=\"CurrentAudioServer\"/>\n"
"    <property access=\"readwrite\" type=\"b\" name=\"PausePlayer\"/>\n"
"    <property access=\"read\" type=\"b\" name=\"AudioServerState\"/>\n"
"  </interface>\n"
        "")
public:
...
public: // PROPERTIES
    Q_PROPERTY(bool AudioServerState READ audioServerState)
    bool audioServerState() const;
    ...
    Q_PROPERTY(QString CurrentAudioServer READ currentAudioServer)
    QString currentAudioServer() const;
    ...
    Q_PROPERTY(bool PausePlayer READ pausePlayer WRITE setPausePlayer)
    bool pausePlayer() const;
