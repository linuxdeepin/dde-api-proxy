...
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.InputDevice1.MouseAdaptor.h"
...
void MouseAdaptor::Enable(bool in0)
{
    // handle method call org.deepin.dde.InputDevice1.Mouse.Enable
    QMetaObject::invokeMethod(parent(), "Enable", Q_ARG(bool, in0));
}

void MouseAdaptor::Reset()
{
    // handle method call org.deepin.dde.InputDevice1.Mouse.Reset
