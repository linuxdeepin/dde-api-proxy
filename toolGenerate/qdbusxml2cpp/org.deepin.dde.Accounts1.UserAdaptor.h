 ...
 * Command line was: qdbusxml2cpp ./dde-api-proxy/file/dbus/v1/system/org.deepin.dde.Accounts1.User.xml -a ./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.Accounts1.UserAdaptor -i ./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.Accounts1.User.h
 *
...
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.Accounts1.User.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
"    <property access=\"read\" type=\"i\" name=\"Workspace\"/>\n"
...
public: // PROPERTIES
    ...
    Q_PROPERTY(int Workspace READ workspace)
    int workspace() const;
