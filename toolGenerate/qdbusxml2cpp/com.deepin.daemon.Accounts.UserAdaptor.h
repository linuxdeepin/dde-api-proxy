...
#ifndef COM_DEEPIN_DAEMON_ACCOUNTS_USERADAPTOR_H
#define COM_DEEPIN_DAEMON_ACCOUNTS_USERADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Accounts.User.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.deepin.daemon.Accounts.User
 */
class UserAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.deepin.daemon.Accounts.User")
