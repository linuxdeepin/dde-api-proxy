...
#ifndef COM_DEEPIN_DAEMON_AUDIO_SOURCEADAPTOR_H
#define COM_DEEPIN_DAEMON_AUDIO_SOURCEADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/com.deepin.daemon.Audio.Source.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface com.deepin.daemon.Audio.Source
 */
class SourceAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "com.deepin.daemon.Audio.Source")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"com.deepin.daemon.Audio.Source\">\n"
