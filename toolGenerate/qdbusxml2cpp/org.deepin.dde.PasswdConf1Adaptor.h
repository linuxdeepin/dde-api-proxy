...
#ifndef ORG_DEEPIN_DDE_PASSWDCONF1ADAPTOR_H
#define ORG_DEEPIN_DDE_PASSWDCONF1ADAPTOR_H

#include <QtCore/QObject>
#include <QtDBus/QtDBus>
#include "./dde-api-proxy/toolGenerate/qdbusxml2cpp/org.deepin.dde.PasswdConf1.h"
QT_BEGIN_NAMESPACE
class QByteArray;
...
/*
 * Adaptor class for interface org.deepin.dde.PasswdConf1
 */
class PasswdConf1Adaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
    Q_CLASSINFO("D-Bus Interface", "org.deepin.dde.PasswdConf1")
    Q_CLASSINFO("D-Bus Introspection", ""
"  <interface name=\"org.deepin.dde.PasswdConf1\">\n"
"    <method name=\"Backup\"/>\n"
...
"  </interface>\n"
        "")
public:
    PasswdConf1Adaptor(QObject *parent);
    virtual ~PasswdConf1Adaptor();
